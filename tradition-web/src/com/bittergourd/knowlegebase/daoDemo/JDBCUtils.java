...
/*public class JDBCUtils {
    private String url = "jdbc2:mysql://localhost:3306/jdbc2";
...
//    private static JDBCUtils innstance = new JDBCUtils();
    ...
    static {
        try {
            Class.forName("com.mysql.jdbc2.Driver");  // 保证注册驱动只会做一次
        } catch (ClassNotFoundException e) {
            throw new ExceptionInInitializerError(e);
        }
    }
...
/*    static void template() throws Exception {
        private static String url = "jdbc2:mysql://localhost:3306/jdbc2";
